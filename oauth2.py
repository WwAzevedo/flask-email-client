...
def GeneratePermissionUrl(client_id, scope='https://www.googleapis.com/auth/gmail.modify openid email profile'):
...
def GenerateOAuth2String(username, access_token):
    ...
    Copy from https://github.com/MU-Software/frost/blob/b9e10a01b9a8f30526dca4f231f19500c96ec7ba/app/common/mailgun/gmail.py
    Args:
    ...
    auth_string = f"user={username}^Aauth=Bearer {access_token}^A^A"
